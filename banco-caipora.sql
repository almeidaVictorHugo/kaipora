CREATE DATABASE  IF NOT EXISTS `caipora` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `caipora`;
-- MySQL dump 10.13  Distrib 8.0.14, for Win64 (x86_64)
--
-- Host: localhost    Database: caipora
-- ------------------------------------------------------
...
CREATE TABLE `animal` (
  ...
  CONSTRAINT `animal_ibfk_2` FOREIGN KEY (`id_dono`) REFERENCES `usuario` (`id_usuario`)
...
INSERT INTO `raca` VALUES (1,'Pastor Alemão','Cão',30),(2,'Holandêss','Coelho',48);
...
-- Dump completed on 2019-06-01 15:55:47
